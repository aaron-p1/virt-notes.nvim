 ...
 local function index_of(table, value) _G.assert((nil ~= value), "Missing argument value on fennel/virt-notes.fnl:67") _G.assert((nil ~= table), "Missing argument table on fennel/virt-notes.fnl:67")
 ...
 local function clear_scheme(path) _G.assert((nil ~= path), "Missing argument path on fennel/virt-notes.fnl:71")
 ...
 local function clean_path(path) _G.assert((nil ~= path), "Missing argument path on fennel/virt-notes.fnl:78")
 ...
 local function file__3enotes_file(file) _G.assert((nil ~= file), "Missing argument file on fennel/virt-notes.fnl:93")
 ...
 local function notes__3evirt_text(notes) _G.assert((nil ~= notes), "Missing argument notes on fennel/virt-notes.fnl:100")
 ...
 local function extmarks__3enotes(extmarks) _G.assert((nil ~= extmarks), "Missing argument extmarks on fennel/virt-notes.fnl:107")
 ...
 local function get_all_notes(bufnr) _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:116")

 local extmarks = nvim_buf_get_extmarks(bufnr, namespace, 0, -1, {details = true})
 return extmarks__3enotes(extmarks) end

 local function get_notes(bufnr, line) _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:121") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:121")
 ...
 local function set_all_notes(bufnr, all_notes, _3fdisable_event) _G.assert((nil ~= all_notes), "Missing argument all-notes on fennel/virt-notes.fnl:128") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:128")
 ...
 local function set_notes(bufnr, line, notes, _3fdisable_event) _G.assert((nil ~= notes), "Missing argument notes on fennel/virt-notes.fnl:140") _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:140") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:140")
 ...
 local function add_note(bufnr, line, note) _G.assert((nil ~= note), "Missing argument note on fennel/virt-notes.fnl:150") _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:150") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:150")
 ...
 local function remove_note(bufnr, line, note) _G.assert((nil ~= note), "Missing argument note on fennel/virt-notes.fnl:157") _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:157") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:157")
 local existing = get_notes(bufnr, line)
 ...
 local function edit_note(bufnr, line, old_note, new_note) _G.assert((nil ~= new_note), "Missing argument new-note on fennel/virt-notes.fnl:164") _G.assert((nil ~= old_note), "Missing argument old-note on fennel/virt-notes.fnl:164") _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:164") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:164")
 local existing = get_notes(bufnr, line)
 ...
 local function note__3eline(line_nr, note) _G.assert((nil ~= note), "Missing argument note on fennel/virt-notes.fnl:171") _G.assert((nil ~= line_nr), "Missing argument line-nr on fennel/virt-notes.fnl:171")
 return (line_nr .. " " .. note) end

 local function line__3enote(line) _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:174")
 return string.match(line, "^(%d+) (.*)$") end

 local function persist_notes(bufnr, file) _G.assert((nil ~= file), "Missing argument file on fennel/virt-notes.fnl:177") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:177")
 ...
 local function parse_notes_file(lines) _G.assert((nil ~= lines), "Missing argument lines on fennel/virt-notes.fnl:190")
 ...
 local function get_notes_from_file(notes_file) _G.assert((nil ~= notes_file), "Missing argument notes-file on fennel/virt-notes.fnl:205")
 ...
 local function load_notes(bufnr, file) _G.assert((nil ~= file), "Missing argument file on fennel/virt-notes.fnl:218") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:218")
 ...
 local function on_choice(callback, _3fchoice) _G.assert((nil ~= callback), "Missing argument callback on fennel/virt-notes.fnl:224")
 if _3fchoice then return callback(_3fchoice) else return nil end end

 local function select_note_on_line(prompt, bufnr, line, callback) _G.assert((nil ~= callback), "Missing argument callback on fennel/virt-notes.fnl:227") _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:227") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:227") _G.assert((nil ~= prompt), "Missing argument prompt on fennel/virt-notes.fnl:227")
 ...
 local function save_note(delete_on_paste_3f, bufnr, line, note) _G.assert((nil ~= note), "Missing argument note on fennel/virt-notes.fnl:246") _G.assert((nil ~= line), "Missing argument line on fennel/virt-notes.fnl:246") _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:246") _G.assert((nil ~= delete_on_paste_3f), "Missing argument delete-on-paste? on fennel/virt-notes.fnl:246")
 _3fsaved_note = {bufnr = bufnr, line = line, note = note}
 delete_note_on_paste_3f = delete_on_paste_3f return nil end

 local function on_buf_read(_40_) local _arg_41_ = _40_ local bufnr = _arg_41_["buf"] _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:250")
 local file = get_absolute_path(bufnr)
 if ("" ~= file) then
 return load_notes(bufnr, file) else return nil end end

 local function on_buf_write(_43_) local _arg_44_ = _43_ local bufnr = _arg_44_["buf"] _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:255")
 local file = get_absolute_path(bufnr)
 if (1 == filereadable(file)) then
 return persist_notes(bufnr, file) else return nil end end

 local function on_virt_notes_updated(_46_) local _arg_47_ = _46_ local bufnr = _arg_47_["buf"] _G.assert((nil ~= bufnr), "Missing argument bufnr on fennel/virt-notes.fnl:260")
 local file = get_absolute_path(bufnr)
 ...
 local function replace_prefix(keys, prefix) _G.assert((nil ~= prefix), "Missing argument prefix on fennel/virt-notes.fnl:334") _G.assert((nil ~= keys), "Missing argument keys on fennel/virt-notes.fnl:334")
 ...
 local function map_keys(prefix, mappings) _G.assert((nil ~= mappings), "Missing argument mappings on fennel/virt-notes.fnl:339") _G.assert((nil ~= prefix), "Missing argument prefix on fennel/virt-notes.fnl:339")
 ...
 local function validate_config(config) _G.assert((nil ~= config), "Missing argument config on fennel/virt-notes.fnl:348")
 ...
 local function apply_config(config) _G.assert((nil ~= config), "Missing argument config on fennel/virt-notes.fnl:361")
 ...
 local function fix_config(config) _G.assert((nil ~= config), "Missing argument config on fennel/virt-notes.fnl:375")
